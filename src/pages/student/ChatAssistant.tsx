  ...
  return (
    <DashboardLayout>
      <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col">
        <div className="max-w-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col h-screen">
          <h1 className="text-3xl font-bold text-gray-100 mb-6">Chat Assistant</h1>
